...
class Banks extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, department, region, bik, corr', 'required'),
			array('region', 'numerical', 'integerOnly'=>true),
			array('addr', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, department, region, bik, corr, addr', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'bankAccounts' => array(self::HAS_MANY, 'BankAccounts', 'bank'),
	...
	public function search()
	{
		...
		$criteria->compare('corr',$this->corr,true);
